...
% saturated version of archTargetGreen for line strokes (arrows, braces) --
% pastel fills read poorly as 1pt strokes, so use this wherever the query/
% target row's color needs to be legible as a line rather than a fill.
\definecolor{archTargetLine}{HTML}{4C8C5C}
