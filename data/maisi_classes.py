"""MAISI (NV-Generate-CTMR) 132-class label vocabulary, vendored from
the repo configs/label_dict.json so patch_icl is self-contained.

MAISI_IDX_TO_CLASS: integer label id -> class name (dummy ids dropped;
200 = body envelope kept). Used by SynthGenMaisiDataset to serve the
synthetic MAISI pairs in their native vocabulary (no TotalSeg remap).
"""
